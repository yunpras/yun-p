...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1889270425ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tabel terakhir" class="drop_button btn">Terbaru</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=db_fakultas&table=tbl_fakultas">`db_fakultas`.`tbl_fakultas`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=siakad&table=tb_mahasiswa">`siakad`.`tb_mahasiswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci-blog&table=admin">`ci-blog`.`admin`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ci-blog&table=migrations">`ci-blog`.`migrations`</a></li></ul></div><div class="drop_list"><button title="Tabel favorit" class="drop_button btn">Favorit</button><ul id="pma_favorite_list"><li class="warp_link">Tidak ada tabel favorit terbaru.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="73692b5659405b31414f283c51456060">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="db_fakultas" targettable="tbl_fakultas">
            ...
            Waktu eksekusi kueri
                            ...
                            <span class="query">SELECT * FROM `tbl_fakultas`</span>
                        </div>
